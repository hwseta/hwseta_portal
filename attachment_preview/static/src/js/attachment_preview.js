...
openerp.attachment_preview = function(instance)
{
    ...
    instance.web.list.Binary.include(
    {
        _format: function (row_data, options)
        {
            ...
            link += _.template(
                '<img class="oe-binary-preview" title="<%-preview_text%>" alt="<%-preview_text%>" data-id="<%-preview_id%>" data-model="<%-preview_model%>" data-field="<%-preview_field%>" data-filename="<%-preview_filename%>" src="/attachment_preview/static/src/img/gtk-print-preview.png" height="50" width="50"/>',
                {

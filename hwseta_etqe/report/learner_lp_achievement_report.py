...
class learner_lp_achievement_certificate(report_sxw.rml_parse):

    def __init__(self, cr, uid, name, context=None):
        super(learner_lp_achievement_certificate, self).__init__(
...
class lp_certificate_report_view(osv.AbstractModel):
    ...
    _template = 'hwseta_etqe.report_learning_programme_achievement_certificate'
    _wrapped_report_class = learner_lp_achievement_certificate
